...
![Alt text](images/cur_learning_rl_fig_2.png?raw=true)

<center><i>Our approach starts with creating random environments from the search-space, trains an agent on them to get their difficult levels, and cluster them according to their difficulty. We use GANs, DNNs, and NEATs to generate new environments  of a given difficulty for curriculum learning.</i></center>
...
![Alt text](images/cur_learning_rl_fig_3.png?raw=true)

<center><i>Environments sorted and clustered according to their difficulty levels. When the difficulty level of an environment is less than 490, it will be categorized as an easy environment. If the difficulty level be between 490 and 630 it will be categorized as a medium environment. If it is more than 630, it will be known as a difficult environment.</i></center>
...
![Alt text](images/cur_learning_rl_fig_4.png?raw=true)

<center><i>Comparing % environment solved (distance covered) by a pre-trained agent for increasingly difficult environments for all the approaches used. The baseline is the performance of the pre-trained agent on these environments without any curriculum.</i></center>
...
![Alt text](images/cur_learning_rl_fig_5.png?raw=true)

<center><i>A sample data distribution generated from noise after a few hundred iterations by our GAN.</i></center>
